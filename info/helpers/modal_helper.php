...
function optinTableSection($state, $state_code, $dob, $lpId = 0, $lpLogId = 0, $zip = 0, $cid = 0)
{
    $annuity_rates = _apiCallForLandingPage(array('state_code' => $state_code, 'yob' => $dob, 'lp_log_id' => $lpLogId, 'cid' => $cid), 'annuity_rates');
    $first_year = isset($annuity_rates['1_year']) ? ($annuity_rates['1_year']) : 0;
    $five_year = isset($annuity_rates['5_year']) ? intval($annuity_rates['5_year']) : 0;
    $ten_year = isset($annuity_rates['10_year']) ? intval($annuity_rates['10_year']) : 0;
    $premium_annuity_rate = isset($annuity_rates['premium_annuity_rate']) ? intval($annuity_rates['premium_annuity_rate']) : 0;
    $campaign_plivo_number = isset($annuity_rates['campaign_ep_number']) ? $annuity_rates['campaign_ep_number'] : '';
    $html = '
<div id="table-section-div" class="hidden">
<div class="exit-popup">
...
marital status, location, investment amount & retirement goals.
        ...
        <form lpformnum="1" class="form-invest" id="form_id2" action="https://admin.financialize.com/api/lead_post.php" method="post">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-box">
                        <a href="javascript:void(0)" onclick="validateOptinForms($(this))">GET MY PERSONALIZED QUOTE</a>
                    </div>
                </div>
                <div class="clearfix"></div>
            </div>
...
' . (($campaign_plivo_number) ? '<div class="p-call-today">
  <div class="p-phone-icon"><i class="fa fa-phone">&nbsp;</i></div>
  <div class="p-phone-copy">Or Call Today: <strong><a href="tel:'.$campaign_plivo_number.'">' . $campaign_plivo_number . '</a></strong></div>
</div>' : '') . '
        </form>
		</div>';
    if ($lpId != '1357') {
