...
/***/
	...
	.row.col-md-12.logo-c{width:100%;}
...
.banner-cont .col-md-4{margin-left:20px;}
    }
...
.banner-cont .col-md-8{padding-right:0;}
.logo-c-img{width:100%;}
.logo-c .col-md-4{ padding:0 !important;}
.banner-cont .col-md-8{padding-left:0 !important;}
.col-md-8.logo-c {
    padding-right: 5px;
}
.greenbar.an-next.col-md-8 {
    margin-bottom: 25px;
}
.footer-decription {
    color: #a6a6a6;
...
.form-b{position:relative;}
  .darkHeader{position:fixed;top:0;}
</style>
...
<div id="Main">
    <div class="container">
        ...
        <div class=" col-md-12 banner-cont">
            ...
            <div class="col-md-4">
                <div  id="FormContainer" class="form-b">
        ...
        <div class="clearfix"></div>
        <div class=" col-md-8 logo-c">
            <img src="https://www.annuities.net/info/images/logos_clone.png" class="logo-c-img">
            <div class="col-md-4">
        ...
        <div class="greenbar an-next col-md-8">
...
<script type="text/javascript">
    ...
    $(window).scroll(function() {    
        ...
        if (scroll >= 170) {
            header.removeClass('form-b').addClass("darkHeader");
        } else {
            header.removeClass("darkHeader").addClass('form-b');
        }
    });
});
</script>
