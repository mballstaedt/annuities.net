<div class="about-annuity investment-annuity">
    ...
    <div class="p-main-text-box">
        ...
        <div class="p-main-text-main-heading more-info">More Information about Annuities</div>
    ...
    <div class="p-main-text-box">
        ...
        <div class="left-div">
            ...
            <img  height="75px" width="75px" alt="certified" src="<?php echo $global['home_link']; ?>images/CoinTree1.jpg">
    ...
    <div class="p-main-text-box">
        ...
        <div class="left-div">
            ...
            <img height="75px" width="75px" alt="certified" src="<?php echo $global['home_link']; ?>images/NestEgg-dollars.jpg">
    ...
    <div class="p-main-text-box">
        ...
        <div class="left-div">
            ...
            <img height="75px" width="75px" alt="certified" src="<?php echo $global['home_link']; ?>images/About-Us green.jpg">
    ...
    <div class="p-main-text-box">
        ...
        <div class="left-div">
            ...
            <img  height="75px" width="75px" alt="certified" src="<?php echo $global['home_link']; ?>images/blocks1-2-3.jpg">
...
.p-wrapper{ background:#fff !important;}
