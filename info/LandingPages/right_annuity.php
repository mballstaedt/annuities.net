        ...
        <div class="p-form-box-main">
            <div class="p-form-left">
                <div class="p-form-left-heading-box">
                    <div class="p-form-heading-xyz">Is an ANNUITY right for you?</div>
                    <div class="p-form-heading-sub">Find the Highest Returns and Compare Your Options!<br>
                        Get a Free Annuity Quote & Report.
                    </div>
                </div>
                    ...
                    <div class="p-form-inner">
                        <form action="<?php echo $global['form_post_url']; ?>"
                            ...
                            <div class=" p-quote-main">
                                <div class=" p-quote-btn"><a id="form_submit1"  href="javascript:void(0)"
                                                             onclick="popUpvalidateForm('<?php echo $pageName; ?>')">FIND OUT NOW</a></div>
                            </div>
                        </form>
            ...
            <div class="p-form-right">
                ...
                <div class="p-tick-box">
                    <div class="p-detail-desc"><i class="p-tick-img"></i>Find Highest Yielding Annuities</div>
                </div>
                <div class="p-tick-box">
