...
function loadingProgressBar(cls, width, sec) {
    ...
    //addClsById('table-section-div','focus-hidden');
    ...
    setTimeout(function () {
        ...
        $('.' + cls).css('width', width + '%');
        if (width < 100)
            loadingProgressBar(cls, width, sec);//call self with new value
        else
            loadingProgressBar2('pb2', 0, 1);//call self with new value
    }, 40);
}
function loadingProgressBar2(cls, width, sec) {
    ...
    setTimeout(function () {
        ...
        $('.' + cls).css('width', width + '%');
        if (width < 100)
            loadingProgressBar2(cls, width, sec);//call self with new value
        else
            loadingProgressBar3('pb3', 0, 1);//call self with new value
    }, 40);
}
function loadingProgressBar3(cls, width, sec) {
    ...
    setTimeout(function () {
        ...
        $('.' + cls).css('width', width + '%');
        if (width < 100)
            loadingProgressBar3(cls, width, sec);//call self with new value
        else {
            setTimeout(function () {
