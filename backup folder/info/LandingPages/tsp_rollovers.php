    ...
    <div class="p-container">
        <div class="p-header-main">
            <div class="p-logo-box">
                ...
                <img src="<?php echo $global['home_link']; ?>images/annuity-logo.jpg"
        ...
        <div class="lp-banner-col">
            <div class="guratee-heading">Maximize your TSP Rollover!</div>
            <div class="interst-listing">
                <ul>
                    <li><a>Get Guaranteed Monthly Income</a></li>
                    <li><a>Find High Returns with NO Market Risk</a></li>
                    <li><a>Protect your Retirement Nest Egg</a></li>
                    <li><a>Rules & Regulations for TSP Transfers</a></li>
                </ul>
            </div>
            <div class="review-form">
                <div class="receive-form-col">
                    <div class="complete-receive">Complete the Form to Receive Your</div>
                    <div class="free-annuity">FREE Thrift Savings Plan Rollover Report <br/>& Annuity Rate Comparison
                    </div>
                    <div class="report-include">
                        This report will help you evaluate your TSP Rollover options, understand
                        the rules governing your TSP, and show you how you can maximize your retirement savings. Each
                        TSP report is customized for your State, Age and Risk Tolerance. What are you waiting for? Fill
                        out the form today!
                    </div>
                    <div class="get-now">
                        To get yours now:
                    ...
                    <div class="get-now-list">
                        <ul>
                            ...
                            <li>Each report takes approximately 3 to 4 hours to complete so please double check your
                    ...
                    <div class="form-box-main">
                        <form class="quotes-form" action="<?php echo $global['form_post_url'] ?>"
                            ...
                            <input type="hidden" name="google_parameters_id"
                                   value="<?php echo $googleParametersId; ?>"/>
                            ...
                            <br/>
                            <label>TSP Savings:<span>*</span></label>
                            ...
                            <a id="form_submit" href="javascript:void(0)"
                               onclick="popUpvalidateForm('<?php echo $pageName; ?>')">GET REPORT & RATES</a>
                        </form>
                    </div>
                </div>
                <div class="clr"></div>
                <div class="value-privacy"><a onClick="pop_ups('leads_from3',true);" href="javascript:void(0);">We Value Your
                        Privacy</a></div>
            </div>
        </div>
        <div class="image-bar">
            <img src="<?php echo $global['home_link'] ?>images/banner-annuity.jpg" title="annuities"
                 alt="annuities bar"/>
        </div>
        <div class="clr"></div>
        <br/><br>
<?php
require_once 'footer_tsp_rollover.php';
?>