...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $global['home_link']; ?>css/custom_bootstrap.css" />
    ...
    <script type="text/javascript" src="<?php echo $global['home_link'] ?>js/bootstrap.js"></script>
...
<div class="p-header-main">
    ...
    <div class="p-logo-box">
        ...
        <img src="<?php echo $annuityLogo ?>" alt="Annuities.com - Free Annuity Rate Quotes"
    ...
    if ($pageId == 1151) {
        ...
        <div class="p-trusted-source_1151">We've helped over <span class="consumer-count">26,000</span> consumers and counting!</div>
    ...
    <?php
        ...
        <div class="p-trusted-source-clone">We've helped over <span class="consumer-count">26,000</span> consumers and counting!</div>
    ...
    <div class="p-form-box-main">
        ...
        <div class="p-form-left1">
            ...
            <div class="p-form-left-heading-box1">
                ...
                <div class="p-form-heading">Get 2016's Best Annuity Rates - FREE</div>
                ...
                <div class="p-form-inner">
                    ...
                    <form action="<?php echo $global['form_post_url'] ?>"
                        ...
                        <div class="p-form-label-box">
                            ...
                            <div class="p-form-label">Phone Number <span class="ph-red">*</span></div>

                            <div class="p-form-inputbox"><input type="text" name="phone_day" id="phone_day"/></div>

                        </div>

                        <div class="p-form-label-box m-hide">

                            <div class="p-form-label">&nbsp;</div>

                            <div class="p-form-inputbox">&nbsp;</div>
                        ...
                        <div class="p-valid-num">
                            ...
                            <span class="ph-red">*</span> A valid <b>phone number</b> is required as we are <br>
        ...
        <div class="p-form-right">
            ...
            <div class="p-why-choose">FREE Annuity <br> Comparison Report </div>
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            ...
                            <div class="p-customer-img-box">
                                ...
                                <div class="p-customer-img"><img src="<?php echo $global['home_link'] ?>images/t1.png" /></div>

                                <div class="p-customer-text">

                                    "If you're thinking about <br/>an Annuity, start here!" <br>

       <span> Jay & Susie C., Austin, TX
                        ...
                        <div class="item">
                            ...
                            <div class="p-customer-img-box ">
                                ...
                                <div class="p-customer-img"><img src="<?php echo $global['home_link'] ?>images/t2.png" /></div>

                                <div class="p-customer-text">

                                    "Super professional and<br> thorough service!"<br>

       <span>Amy H. Tustin, CA </span>
                        ...
                        <div class="item">
                            ...
                            <div class="p-customer-img-box ">
                                ...
                                <div class="p-customer-img"><img src="<?php echo $global['home_link'] ?>images/t3.png" /></div>

                                <div class="p-customer-text">

                                    "Easy, helpful, quick, <br/>private...enough said!" <br>

       <span>Spencer S., Phoenix, AZ
