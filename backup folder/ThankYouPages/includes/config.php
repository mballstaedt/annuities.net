...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
	...
	{	
		...
		## LIVE NEW SERVER
        $global['home_link'] = HTTP_PREFIX_STR . $_SERVER['SERVER_NAME'].'/ThankYouPages/';
		...
		$global['rootPath'] = '/home/anuitiesnt/public_html/ThankYouPages/'; ///home/annuities/public_html/offers/
	}
