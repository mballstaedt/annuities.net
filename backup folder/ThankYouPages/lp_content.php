...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $global['home_link'] ?>typ_styles/css/p-style.css" />
    ...
    <link type="text/css" href="<?php echo $global['home_link'] ?>css/style.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $global['home_link'] ?>css/RMortgage_reset.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $global['home_link'] ?>css/RMortgage_style.css" rel="stylesheet" />
    <link type="text/css" href="<?php echo $global['home_link'] ?>css/fonts.css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="<?php echo $global['home_link']?>js/typ.js"></script>
    <script>
        $(function () {
