 ...
 ****************************************************************/
if (!isset($dataRequest['device_type'])) {
    include_once('../info/classes/Mobile_Detect.php');
    $detect = new Mobile_Detect;
    $dataRequest['device_type'] = ($detect->isMobile() ? ($detect->isTablet() ? 'tablet' : 'mobile') : 'computer');
...
if (isset($landingPageData['api_status']) && $landingPageData['api_status'] == 'success') {
    ...
    $templateID = (isset($landingPageData['template_id'])) ? $landingPageData['template_id'] : '';
