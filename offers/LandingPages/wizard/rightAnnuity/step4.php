...
<style>
    ...
    .skip a{background:none;border:0px;box-shadow:none;color:orange;margin-left: -45px; font-weight: 300;text-decoration: underline !important; font-family: sans-serif;
        font-size: 20px;}
...
<div class="right-col-box">
    ...
    <div class="testimonialbox">
      <img width="72px" src="<?php echo $global['home_link'] ?>LandingPages/wizard/rightAnnuity/images/Mike Zunich.jpg" alt="user"/>
