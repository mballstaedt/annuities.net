...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $global['home_link'] ?>LandingPages/wizard/rightAnnuity/css/style.css"/>
...
<div class="wrapper">
    <div class="container">
        <header>
            <div class="logo"><a href="#"><img src="<?php echo $global['home_link'] ?>images/annuity-logo.jpg" width="250" alt="logo"/></a></div>
            <div class="header-slogan">Annuities.com: The Most Trusted Source for Annuity Information</div>
            <div class="clr"></div>
        </header>