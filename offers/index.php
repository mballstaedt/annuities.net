...
if (isset($landingPageData['api_status']) && $landingPageData['api_status'] == 'success') {
    ...
    $lpExitPopup = (isset($landingPageData['exit_popup_id']) && $landingPageData['exit_popup_id'] > 0) ? $landingPageData['exit_popup_id'] : 1;
...
if (isset($postData['device_type']) && in_array($postData['device_type'], array('tablet', 'mobile'))) {
