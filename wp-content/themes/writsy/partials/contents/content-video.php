<?php
/**
 * The template for displaying posts in Video format.
 *
 * @package Writsy
 * @since   1.0.0
 */
...
$video = writsy_get_meta(get_the_ID(), 'video_file');
$embed = writsy_get_meta(get_the_ID(), 'video_url');
        ...
        <div class="entry-video">
            ...
            if ($video) {
                ...
                if (has_post_thumbnail()) {
                    $args['poster'] = esc_url(current(wp_get_attachment_image_src(get_post_thumbnail_ID(), 'writsy-monitor')));
                }
