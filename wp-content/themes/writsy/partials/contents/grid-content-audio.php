<?php
/**
 * The default template for displaying Audio posts in grid layout.
 *
 * @package Writsy
 * @since   1.0.0
 */
...
if (writsy_get_meta(get_the_ID(), 'audio_url')) {
    return get_template_part('partials/contents/grid-content', 'audio-embed');
}
?>
    ...
    <?php if (has_post_thumbnail()) : ?>
        <div class="entry-media">
            <a href="<?php the_permalink(); ?>" class="entry-thumbnail">
                ...
                <span class="entry-media-button volume"></span>
            </a>
        </div>
    <?php endif; ?>
